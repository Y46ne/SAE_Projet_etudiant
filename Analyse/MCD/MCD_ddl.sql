...
ALTER TABLE ASSUREUR ADD FOREIGN KEY (id_assure_2) REFERENCES ASSURE (id_assure);
ALTER TABLE ASSUREUR ADD FOREIGN KEY (id_logement) REFERENCES LOGEMENT (id_logement);
ALTER TABLE ASSUREUR ADD FOREIGN KEY (id_assure_1) REFERENCES ASSURE (id_assure);
